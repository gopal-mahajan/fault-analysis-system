...
//
//    private  Map<String, PowerSystemDevice> powerSystemDeviceMap;
//    private  Map<String, Transformer> transformerMap;
//
//    public FaultRepository() {
//        powerSystemDeviceMap = powerSystemDeviceRepository.getPowerSystemDeviceMap();
//        transformerMap = powerSystemDeviceRepository.getTransformerMap();
//    }
//
